...
export default function CityCard({ city, count }: Props) {
  return (
    <Link
      className="snap-start group flex flex-col bg-white border border-gray-200 rounded-xl hover:shadow-lg focus:outline-hidden focus:shadow-lg transition duration-400 ease-in-out"
      href={`/areas/${city.toLowerCase().replace(/ /g, "-")}`}
    >
      <div className="p-4 md:p-5 w-60">
